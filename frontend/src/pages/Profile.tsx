...
export default function Profile() {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-5 mb-5 animate-fadeIn">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
        <h3 className="text-sm sm:text-[15px] font-medium text-gray-900">My profile</h3>
        <button
          onClick={handleSaveProfile}
          disabled={saving}
          className="inline-flex items-center justify-center gap-1.5 bg-[#185FA5] text-white rounded-md px-4 py-2 sm:py-1.5 text-xs font-sans hover:bg-[#0C447C] transition-all disabled:opacity-60 w-full sm:w-auto"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-[180px_1fr] gap-6">
        <div className="flex sm:flex-col items-center gap-3 sm:gap-3">
          <div className="w-16 h-16 sm:w-20 sm:h-20 shrink-0 rounded-full bg-[#E6F1FB] flex items-center justify-center text-2xl sm:text-3xl font-medium text-[#185FA5]">
            {initials || 'AD'}
          </div>
          <div className="text-left sm:text-center flex-1 sm:flex-none">
            <div className="text-sm sm:text-[15px] font-medium text-gray-900">{name}</div>
            <div className="text-xs text-gray-400">{role}</div>
            <button className="mt-2 sm:mt-2 border border-gray-200 rounded-md px-2.5 py-1 text-xs text-gray-500 hover:bg-gray-50 flex items-center gap-1 sm:mx-auto">
        ...
        <div>
          ...
          <div className="flex justify-end mt-4">
            <button
              ...
              className="border border-gray-200 rounded-md px-4 py-2 sm:py-1.5 text-xs text-gray-700 hover:bg-gray-50 flex items-center justify-center gap-1.5 disabled:opacity-60 w-full sm:w-auto"
            >
